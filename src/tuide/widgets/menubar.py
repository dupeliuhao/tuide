...
class MenuBar(Horizontal):
    ...
    def compose(self):
        ...
        yield Button("WS", id="menu-find-workspace", classes="menu-button")
        ...
        yield Button("Bla", id="menu-git-blame", classes="menu-button")
        ...
        yield Button("Q", id="menu-quit", classes="menu-button")
