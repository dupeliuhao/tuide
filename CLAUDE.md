...
- **Esc goes back one layer**: `Esc` should dismiss the active modal or popup first; if no overlay is open, it should open the quit confirmation rather than doing nothing.
